        ...
        <section class="blog-page">
            <div class="container container--padding">
                <div class="blog-page__inner">
                    <h1 class="h3 blog-page__title"><?php echo get_field('title', get_page_by_path('stories')) ?></h1>
                    <p class="blog-page__description"><?php echo get_field('description', get_page_by_path('stories')) ?></p>
                    <h2 class="h4 h4--bold blog-page__menu-title"><?php echo get_field('menu_title', get_page_by_path('stories')) ?></h2>
                    <?php wp_nav_menu(
                        [
                            'theme_location' => 'blog-menu',
                            'container_class' => 'blog-page__menu',
                        ]
                    ) ?>
