        ...
        <section class="blog-page">
            <div class="container container--padding">
                <div class="blog-page__inner">
                    ...
                    <h2 class="h4 h4--bold blog-page__menu-title"><?php echo get_field('menu_title', get_page_by_path('blog')) ?></h2>
                    <?php wp_nav_menu(
                        [
                    ...
                    <div class="blog-page__post-list">
                        ...
                        ?>
                        <div class="loader-section shown"><div class="loader"></div></div>
                    </div>
