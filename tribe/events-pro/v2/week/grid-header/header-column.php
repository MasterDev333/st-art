	...
	<h3 class="tribe-events-pro-week-grid__header-column-title">
		...
		>
			<span class="tribe-events-pro-week-grid__header-column-weekday tribe-common-h8 tribe-common-h--alt">
				<?php echo date_format(date_create($day[ 'weekday' ]), 'l') ; ?>
			</span>
            <span class="tribe-events-pro-week-grid__header-column-weekday tribe-events-pro-week-grid__header-column-weekday--short">
