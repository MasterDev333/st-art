	...
	>
		...
		>
			<span class="tribe-events-c-top-bar__datepicker-mobile">
				<?php echo date_format(date_create($week_start_date), 'F Y'); ?>
			</span>
			<span class="tribe-events-c-top-bar__datepicker-desktop tribe-common-a11y-hidden">
				<?php echo date_format(date_create($week_start_date), 'j F'); ?>
			</span>
		</time>
		...
		>
			<span class="tribe-events-c-top-bar__datepicker-desktop tribe-common-a11y-hidden">
				<?php echo date_format(date_create($week_end_date), 'j F Y'); ?>
			</span>
		</time>
